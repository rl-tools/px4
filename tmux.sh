...
tmux send-keys -t px4:0.3 'echo "waiting for Mocap..."; sleep 5' C-m '. .venv/bin/activate' C-m 'export MAVLINK_POSE_TOPIC="/vicon/race_jonas/odom"' C-m 'export MAVLINK_URL="udp:localhost:14551"' C-m 'python3 tools/external_position_reference/forward_ros_to_mavlink.py' C-m
